...
export namespace Images {
  ...
  export class ImagesTeal {
    ...
    static getPNG(): string {
      return require("assets/images/teal.png");
    }
  }
...
export namespace Spritesheets {
  export class SpritesheetsMetalslugMummy374518 {
    static getName(): string {
      return "metalslug_mummy.[37,45,18,0,0]";
    }

    static getPNG(): string {
      return require("assets/spritesheets/metalslug_mummy.[37,45,18,0,0].png");
    }
...
export namespace Atlases {
  ...
  export class AtlasesPreloadSpritesHash {
    static getName(): string {
      return "preload_sprites_hash";
    }

    static getJSONHash(): string {
      return require("assets/atlases/preload_sprites_hash.json");
    }

    static getPNG(): string {
      return require("assets/atlases/preload_sprites_hash.png");
    }
  }
  ...
  export class AtlasesPreloadSpritesXml {
    static getName(): string {
      return "preload_sprites_xml";
    }

    static getPNG(): string {
      return require("assets/atlases/preload_sprites_xml.png");
    }

    static getXML(): string {
      return require("assets/atlases/preload_sprites_xml.xml");
    }
  }
...
export namespace Audio {
  export class AudioMusic {
    ...
    static getAC3(): string {
      return require("assets/audio/music.ac3");
    }
    static getM4A(): string {
      return require("assets/audio/music.m4a");
    }
    static getMP3(): string {
      return require("assets/audio/music.mp3");
    }
    static getOGG(): string {
      return require("assets/audio/music.ogg");
    }
  }
}
...
export namespace Audiosprites {
  export class AudiospritesSfx {
    ...
    static getAC3(): string {
      return require("assets/audiosprites/sfx.ac3");
    }
    static getJSON(): string {
      return require("assets/audiosprites/sfx.json");
    }
    static getM4A(): string {
      return require("assets/audiosprites/sfx.m4a");
    }
    static getMP3(): string {
      return require("assets/audiosprites/sfx.mp3");
    }
    static getOGG(): string {
      return require("assets/audiosprites/sfx.ogg");
    }
  }
...
export namespace CustomWebFonts {
  export class Fonts2DumbWebfont {
    ...
    static getCSS(): string {
      return require("!file-loader?name=assets/fonts/[name].[ext]!assets/fonts/2Dumb-webfont.css");
    }
    static getEOT(): string {
      return require("!file-loader?name=assets/fonts/[name].[ext]!assets/fonts/2Dumb-webfont.eot");
    }
    static getSVG(): string {
      return require("!file-loader?name=assets/fonts/[name].[ext]!assets/fonts/2Dumb-webfont.svg");
    }
    static getTTF(): string {
      return require("!file-loader?name=assets/fonts/[name].[ext]!assets/fonts/2Dumb-webfont.ttf");
    }
    static getWOFF(): string {
      return require("!file-loader?name=assets/fonts/[name].[ext]!assets/fonts/2Dumb-webfont.woff");
    }
  }
}
...
export namespace BitmapFonts {
  export class FontsFontFnt {
    ...
    static getFNT(): string {
      return require("assets/fonts/font_fnt.fnt");
    }
    static getPNG(): string {
      return require("assets/fonts/font_fnt.png");
    }
  }
  export class FontsFontXml {
    ...
    static getPNG(): string {
      return require("assets/fonts/font_xml.png");
    }
    static getXML(): string {
      return require("assets/fonts/font_xml.xml");
    }
  }
}
...
export namespace Scripts {
  ...
  export class ScriptsBlurY {
    ...
    static getJS(): string {
      return require("assets/scripts/BlurY.js");
    }
  }
}
export namespace Shaders {
  export class ShadersPixelate {
    ...
    static getFRAG(): string {
      return require("assets/shaders/pixelate.frag");
    }
  }
}
